...
struct DfuStrings {
    ...
    static let alternativeAdvertisingNameTitle = "Alternative Advertising Name"
    static let alternativeAdvertisingNameValue = "Sets advertising name that will be displayed on a device after flashing it."
    static let alternativeAdvertisingNameDialogInfo = "Please set advertising name:"
